...
const Homepage = ()=>{
    ...
    return(
      ...
      <header className="text-center mb-8">
        <h1 className="text-4xl font-bold">BookWeb</h1>
  ...
  <h2 className="text-3xl text-center text-gray-800 mb-8">How BookWeb Works</h2>
  <div className="flex justify-center">
    <div className="max-w-lg">
      <h3 className="text-x1 text-gray-500 mb-4">1. Login or Create Your Account</h3>
      <h3 className="text-x1 text-gray-500 mb-4">2. Search for and find your next dream book</h3>
      <h3 className="text-x1 text-gray-500 mb-4">3. Connect with the book owner via WebChat</h3>
      <h3 className="text-x1 text-gray-500">4. Get the book and enjoy your reading!</h3>
    </div>
  </div>
</section>
