...
import {  FaRegHandPaper,FaBookOpen,FaBook,FaUser,FaUserCircle,FaInfoCircle,FaList } from "react-icons/fa";
...
const Viewbooks = () => {
  ...
  <div className="mb-4 border-b-2  border-gray-500 pb-2">
    <p className="text-lg font-bold flex mt-2 mb-2 ">
      <FaUser className="mr-2 text-black mt-1" />  {/* Author icon */}
      Author
    </p>
  ...
  <div className="mb-4 border-b-2 border-gray-500 pb-2">
    <p className="text-lg font-bold flex mb-2 mt-2">
      <FaUserCircle className="mr-2 text-black mt-1" />  {/* Owner icon */}
      Owner
    </p>
